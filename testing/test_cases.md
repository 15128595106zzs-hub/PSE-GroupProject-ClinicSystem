...
| **TC-04** | **Booking Process** | Click "CONFIRM BOOKING"  | System displays "Appointment Successful!" (Screen 4) with correct summary. | <img src="test_confirme.png" width="150"> | **Pass** |
